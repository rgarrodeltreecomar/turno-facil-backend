...
namespace Api.ClinicaMedica.Migrations
{
    ...
    [Migration("20250526180507_ImplementaciónTablaPaquetesServicios")]
    partial class ImplementaciónTablaPaquetesServicios
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api.ClinicaMedica.Entities.PaqueteServicio", b =>
                {
                    ...
                    b.Property<Guid>("PaqueteCodigoPaquete")
                        .HasColumnType("char(36)");

                    b.Property<string>("PaqueteIdConsulta")
                        .IsRequired()
                        .HasColumnType("varchar(50)");

                    b.Property<string>("ServicioIdServicio")
                        .IsRequired()
                        .HasColumnType("varchar(50)");
                    ...
                    b.HasIndex("PaqueteIdConsulta", "PaqueteCodigoPaquete");
            ...
            modelBuilder.Entity("Api.ClinicaMedica.Entities.PaqueteServicio", b =>
                {
                    ...
                    b.HasOne("Api.ClinicaMedica.Entities.Paquetes", "Paquete")
                        ...
                        .HasForeignKey("PaqueteIdConsulta", "PaqueteCodigoPaquete")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
